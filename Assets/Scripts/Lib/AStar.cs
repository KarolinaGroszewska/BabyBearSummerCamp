...
IList<Vector2Int> reconstructPath(Dictionary<Vector2Int, Vector2Int> cameFrom, Vector2Int current)
{
...
void process(Vector2Int neighbor, Dictionary<Vector2Int, int> gScore, Dictionary<Vector2Int, int> fScore, Dictionary<Vector2Int, Vector2Int> cameFrom, PriorityQueue<int, Vector2Int> openSet, Vector2Int current, Vector2Int goal)
{
...
IList<Vector2Int> A_Star(Vector2Int start, Vector2Int goal, Vector2Int tilemapDimensions)
{
